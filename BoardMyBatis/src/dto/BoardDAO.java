...
public class BoardDAO {
	...
	public BoardDAO() throws IOException {
		...
		String xmlPath = "dto/myBatis-config.xml";
	...
	public int count(String word, int mode) {
		
		PageIn pageIn = new PageIn(word, mode);
		long cnt;
		
		SqlSession session = factory.openSession(true);
		
		List list = session.selectList("board.selectCountFind", pageIn);
	...
	public List find(String word, int mode, int pageNum, int pageSize) {
		
		int start = pageNum * pageSize;
		PageIn pageIn = new PageIn(start, pageSize, word, mode);
		
		SqlSession session = factory.openSession(true);
		
		List list = session.selectList("board.selectPageFind", pageIn);
