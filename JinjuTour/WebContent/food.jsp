...
<body id="top">
    ...
    <section class="sub-contents">
        ...
        <ul>
            <li>
                <a href="food-view.jsp">
                    ...
                    <div class="content">
                        ...
                        <p class="sub-content">장남인 하연규, 박군자 부부가 가업을 이어 '박군자 진주냉면' 으로 2대에 걸쳐 천년 진주냉면의 정통 명맥을 이어오고 있습니다.</p>
            ...
            <li>
                <a href="food-view.jsp">
                    <img class="imgw100" src="images/food_02.jpg" alt="설야 진주 전통 비빔밥">
                    <div class="content">
                        <p class="sub-title">설야 진주 전통 비빔밥</p>
                        <p class="sub-content">화학조미료를 쓰지 않고 최상의 재료로 재료 본연의 맛을 그대로 살려 많은 사람이 찾고 있습니다.</p>
                        <p class="sub-address"><i class="fa fa-map-marker"></i> 경남 진주시 동진로 169</p>
                        <div class="count">
                            <i class="fa fa-heart heartIcon"></i>
            ...
            <li>
                <a href="food-view.html">
                    ...
                    <div class="content">
                        ...
                        <p class="sub-content">저희 유정장어는 진주시로부터 향토음식점으로 선정받아 45년간 장어구이맛의 정통을 계승보존하고자 노력하고 있습니다.</p>
                        <p class="sub-address"><i class="fa fa-map-marker"></i> 경남 진주시 진주성로 2</p>
                        <div class="count">
                            <i class="fa fa-heart heartIcon"></i>
            ...
            <li>
                <a href="food-view.html">
                    <img class="imgw100" src="images/food_04.jpg" alt="홍제원">
                    <div class="content">
                        <p class="sub-title">홍제원</p>
                        <p class="sub-content">진주 남강 옆에 위치한 한우모듬구이 및 돼지갈비가 유명한 곳이다.</p>
                        <p class="sub-address"><i class="fa fa-map-marker"></i> 경남 진주시 남강로 1171</p>
                        <div class="count">
                            <i class="fa fa-heart heartIcon"></i>
            ...
            <li>
                <a href="food-view.html">
                    <img class="imgw100" src="images/food_05.jpg" alt="송화한정식">
                    <div class="content">
                        <p class="sub-title">송화한정식</p>
                        <p class="sub-content">전통궁중한정식이며 코스별요리 및 15가지 이상의 찬과 후식이 나오는 한정식 전문점입니다.</p>
                        <p class="sub-address"><i class="fa fa-map-marker"></i> 경상남도 진주시 도동천로 82</p>
                        <div class="count">
                            <i class="fa fa-heart heartIcon"></i>
