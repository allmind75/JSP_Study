        ...
        <ul>
            <li class="notice">
                ...
                <div class="notice-context">
                    <p class="context">
                        안녕하세요. 진주투어입니다.<br/> 오늘은 진주투어 업데이트 소식을 전해드리려고<br/> 이렇게 공지로 찾아왔습니다.<br/>
                    </p>
                </div>
            </li>
            <li class="notice">
            ...
            <li class="notice">
                ...
                <div class="notice-context">
                    <p class="context">
                        안녕하세요. 진주투어입니다.<br/> 2월30일부터 1월 12일까지 진행된<br/> 새해맞이 이벤트 당참자를 발표합니다!<br/> 당참자분들께는 개별적으로 연락을 드릴 예정 입니다.<br/> 이벤트 상품으로 “진주투어 달력”을 제작하여<br/> 보내드리오니 꼭 메시지 확인 바랍니다.<br/>
                    </p>
                </div>
            </li>
        </ul>
