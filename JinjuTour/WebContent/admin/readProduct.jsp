        ...
        <form class="input" name="myform" method="post" onsubmit="return writeCheck()">
            <ul>
                <li>
                    ...
                    <input type="text" name="title" class="id" id="input-title" placeholder="특산물 이름 입력" autofocus value="${boardVO.title}" readonly="readonly">
                </li>
                <li>
                    <label for="input-content" class="readonly">특산물 설명 입력</label>
                    <textarea name="content" id="content" placeholder="특산물 설명 입력" readonly="readonly">${boardVO.content}</textarea>
                </li>
                <li>
                    <label for="input-address" class="readonly">특산물 주소 입력</label>
                    <input type="text" name="address" class="id" id="input-address" placeholder="특산물 주소 입력" value="${boardVO.address}" readonly="readonly">
                </li>
                 <li>
                    <label for="input-phone" class="readonly">특산물 연락처 입력</label>
                    <input type="text" name="phone" class="id" id="input-phone" placeholder="특산물 연락처 입력" value="${boardVO.phone}" readonly="readonly">
                </li>
                <li>
                    <label for="input-link" class="readonly">특산물 홈페이지 주소 입력</label>
                    <input type="text" name="link" class="id" id="input-link" placeholder="특산물 홈페이지 주소 입력" value="${boardVO.link}" readonly="readonly">
                </li> 
                 <li>
    ...
    <script>
        ...
        $(document).ready(function() {
        	...
        	$("#modifyBtn").on("click", function() {
        		formObj.attr("action", "modifyReadPage.po");
        		formObj.attr("method", "get");
        		formObj.submit();
        	});
        	
        	$("#removeBtn").on("click", function() {
        		formObj.attr("action", "removePage.po");
        		formObj.submit();
        	});
        	
        	$("#goListBtn").on("click", function() {
        		formObj.attr("action", "list.po");
        		formObj.attr("method", "get");
        		formObj.submit();
        	})
        })
