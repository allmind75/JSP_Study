...
<body>
    ...
    <div class="adminbox">
        ...
        <form class="input" name="myform" action="trip_board_save.jsp" method="get" enctype="multipart/form-data">
            <ul>
                <li>
                ...
                <li>
                    <label for="input-content" class="readonly">관광지 정보 입력</label>
                    <textarea name="content" placeholder="관광지 정보 입력"></textarea>
                </li>
                <li>
                    <label for="input-address" class="readonly">관광지 주소 입력</label>
                    <input type="text" name="address" class="pw" id="input-address" placeholder="관광지 주소 입력">
                </li>
                <!-- 
                <li>
